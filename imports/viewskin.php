...
<footer>
    <div class="wrapper">
        ...
        <div class="actions">
            ...
            <a class="main-btn" href="<?= GetPrefix(); ?>ranks">
                <?= $translations->ranks->button ?>
                <svg viewBox="0 0 576 512"><path d="M528.1 171.5L382 150 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0L194 150 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6L105.7 319 81 464.8c-4.5 26.2 23 46 46.4 33.7L288 439.6l160.6 58.9c23.4 12.3 50.9-7.5 46.4-33.7L470.3 319l75.5-92.9c19-18.5 8.5-50.8-17.7-54.6z"/></svg>
            </a>
        </div>
    </div>
</footer>